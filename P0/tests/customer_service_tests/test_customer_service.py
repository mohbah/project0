...
customer_not_on_database= Customer(81, 1270285,"Beck", "Ronaldo", 9137378739)

def test_validate_create_customer_method():
    customer = customer_service.service_create_customer(customer_not_on_database)
    assert customer.last_name == "Ronaldo"
...
def test_validate__get_customer_information():
    customer = customer_service.service_get_customer_by_id(10)
